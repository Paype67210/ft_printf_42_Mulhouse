...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/09 10:52:37 by pdeson            #+#    #+#             */
/*   Updated: 2023/12/13 10:14:15 by pdeson           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_x(void)
{
	...
	x = 0;
	y = 0;
	printf("Testing: (\"\\tdgs%%xxx\\n\", 10)\n");
	x += printf("  Or\t:\tdgs%xxx\n", 10);
	y += ft_printf("  Ft\t:\tdgs%xxx\n", 10);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = 0;
	y = 0;
	printf("Testing: (\"\\t%%x%%xx%%x\\n\", 1, 2, -3)\n");
	x += printf("  Or\t:\t%x%xx%x\n", 1, 2, -3);
	y += ft_printf("  Ft\t:\t%x%xx%x\n", 1, 2, -3);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
}
...
void	test_u(void)
{
	...
	x = 0;
	y = 0;
	printf("Testing: (\"\\tdgs%%uxx\\n\", 10)\n");
	x += printf("  Or\t:\tdgs%uxx\n", 10);
	y += ft_printf("  Ft\t:\tdgs%uxx\n", 10);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
	x = 0;
	y = 0;
	printf("Testing: (\"\\t%%u%%uu%%uxx\\n\", 1, 2, -3)\n");
	x += printf("  Or\t:\t%u%uu%u\n", 1, 2, -3);
	y += ft_printf("  Ft\t:\t%u%uu%u\n", 1, 2, -3);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
}
...
void	test_p(void)
{
	...
	x = 0;
	y = 0;
	printf("Testing: (\"\\t%%pp%%p%%p\\n\", (void *)ULONG_MAX + 423856, (void *)0, (void *)INT_MAX)\n");
	x += printf("  Or\t:\t%pp%p%p\n", (void *)ULONG_MAX + 423856, (void *)0, (void *)INT_MAX);
	y += ft_printf("  Ft\t:\t%pp%p%p\n", (void *)ULONG_MAX + 423856, (void *)0, (void *)INT_MAX);
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
}
